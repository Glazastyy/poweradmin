...
return [
    ...
    'interface' => [
        ...
        'enabled_languages' => 'cs_CZ,de_DE,en_EN,es_ES,et_EE,fi_FI,fr_FR,hr_HR,hu_HU,id_ID,it_IT,ja_JP,ko_KR,lt_LT,lv_LV,nb_NO,nl_NL,pl_PL,pt_BR,pt_PT,ro_RO,ru_RU,sk_SK,sr_RS,sv_SE,tr_TR,uk_UA,vi_VN,zh_CN', // Added in 3.8.0
        ...
        'cache_enabled' => true,              // Enable short-lived UI data cache for expensive API-mode list/search screens (added in 4.7.0)
        'cache_ttl' => 60,                    // UI data cache TTL in seconds; set to 0 to disable (added in 4.7.0)
        'cache_dir' => '/tmp/poweradmin-ui-cache', // UI data cache directory (added in 4.7.0)
    ...
    'pdns_api' => [
        ...
        'timeout' => 10,                           // PowerDNS API request timeout in seconds (added in 4.4.0)
    ...
    'misc' => [
        ...
        'timezone' => 'UTC',                           // Default timezone (e.g. 'Europe/Berlin', 'Asia/Shanghai')
